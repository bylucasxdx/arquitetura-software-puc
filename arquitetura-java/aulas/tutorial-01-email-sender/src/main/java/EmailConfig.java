...
public class EmailConfig {
	...
	private void configContent(String toEmail, String subject, String body, MimeMessage message) {
		try {
			message.setFrom(new InternetAddress("lucasmedeiros1994@gmail.com", "Lucas Medeiros"));
			message.setReplyTo(InternetAddress.parse("lucasmedeiros1994@gmail.com", false));
